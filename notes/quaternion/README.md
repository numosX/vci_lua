...
* わかったようなことを書いていながら、わかってない記事も多く、余計に混乱した記憶がある。
* まずは「回転行列みたいなもんです」っと説明した上で、「使い方はこうです」って説明があっても良いのではないか。そんな問いかけを込めて、切り抜きを投稿した次第である。
* 結局のところ、使えてなんぼ。ときには難しい計算をすることもあるけれど、基本的には頭ではなく心で数式を読んでいきたいものだ。
